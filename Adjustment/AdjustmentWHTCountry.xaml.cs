...
namespace Adjustment
{
    ...
    /// </summary>
    public partial class AdjustmentWHTCountry : ScreenBase, IPreBindable 
    {
        ...
        public AdjustmentWHTCountry(AdjustmentFolder _AdjFolderScreen)
            : base()
        {
        //    //set obj
            this.CurrentBusObj = WHTAdjustmentBusObj;
            //name obj
            this.CurrentBusObj.BusObjectName = "AdjustmentWHTCountry";
        ...
        private void Calculate_WHT()
        {
            ...
            //whtComputed = incomeSubjectWHT * (whtRate / 100);
        ...
        public override void Save()
        {
            ...
            if (this.CurrentBusObj.ObjectData != null)
                if (this.CurrentBusObj.ObjectData.Tables["remit"].Rows.Count > 0)
                {
                    ...
                    NewDocID = cGlobals.BillService.InsertNewAdjustmentPreamble(txtDocument.Text, 21, cGlobals.UserName.ToLower(), whtComputed * -1);
        ...
        private void cmbCountry_LostFocus(object sender, RoutedEventArgs e)
        {
            if (this.CurrentBusObj.HasObjectData)
            {
                if (this.CurrentBusObj.ObjectData.Tables["main"] == null || this.CurrentBusObj.ObjectData.Tables["main"].Rows.Count == 0)
                    return;
                this.CurrentBusObj.changeParm("@country_id", cmbCountry.SelectedValue.ToString());
                this.CurrentBusObj.changeParm("@province_id", cmbProvince.SelectedValue.ToString());
                //this.CurrentBusObj.LoadTable("province");
                this.CurrentBusObj.LoadTable("dddwproduct");
            }
        ...
        private void cmbProductItem_LostFocus(object sender, RoutedEventArgs e)
        {
            if (this.CurrentBusObj.HasObjectData)
            {
                ...
                AdjWHTVerification.Parms.AddParm("@country_id", cmbCountry.SelectedValue);
                AdjWHTVerification.Parms.AddParm("@province_id", cmbProvince.SelectedValue);
                if (cmbProductItem.SelectedValue == null)
                    AdjWHTVerification.Parms.AddParm("@item_id", 0);
                else
