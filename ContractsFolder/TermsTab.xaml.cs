...
namespace ContractsFolder
{
    ...
    #region class TermsTab
    /// <summary>
    /// This class represents a 'TermsTab' object.
    /// </summary>
    public partial class TermsTab : ScreenBase
    {
        ...
        #region Constructor
        /// <summary>
        /// Create a new instance of a 'TermsTab' object and call the ScreenBase's constructor.
        /// </summary>
        public TermsTab()
            : base()
        {
