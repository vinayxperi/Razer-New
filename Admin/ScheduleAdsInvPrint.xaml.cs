...
namespace Admin
{
    ...
    /// Interaction logic for ScheduleAdsInvPrint.xaml

    public partial class ScheduleAdsInvPrint : ScreenBase, IScreen 
    {

        private static readonly string mainTableName = "ScheduleAdsInvPrint";
        public static readonly string jobName = "Ads Print";
        ...
        private void btnOK_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            ...
            {
                sParms = " /A " + cmbPrinters.SelectedValue.ToString();
