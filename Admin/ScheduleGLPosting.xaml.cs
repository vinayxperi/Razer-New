...
namespace Admin
{
    ...
    /// Interaction logic for ScheduleGLPosting.xaml

    public partial class ScheduleGLPosting : ScreenBase, IScreen
    {
        private static readonly string fieldLayoutResource = "GLtoPost";
        private static readonly string mainTableName = "glAvail";
        public static readonly string jobName = "GLPOST";
        ...
        public void Init(cBaseBusObject businessObject)
        {
            ...
            businessObject.BusObjectName = "ScheduleGLPost";
            this.CanExecuteSaveCommand = false;
            string userValueField = "user_id";
            string userDisplayField = "user_name";
            gGLToPost.WindowZoomDelegate = ReturnSelectedData;
            gGLToPost.xGrid.FieldLayoutSettings = layouts;
            gGLToPost.FieldLayoutResourceString = fieldLayoutResource;
            gGLToPost.MainTableName = mainTableName;
            ...
            gGLToPost.SetGridSelectionBehavior(false, true);
            gGLToPost.LoadGrid(businessObject, "glAvail");
