...
namespace Admin
{
    ...
    /// Interaction logic for ScheduleDefPool.xaml

    public partial class ScheduleDefPool : ScreenBase, IScreen 
    {
 
        private static readonly string mainTableName = "recogPeriod";  
        public static readonly string jobName = "DEFPOOL";
