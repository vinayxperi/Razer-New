...
namespace RazerBase.Lookups
{
    ...
    /// </summary>
    public partial class BCFLookup : DialogBase, IScreen
    {
        ...
        public void Init(cBaseBusObject businessObject)
        {
            ...
            uBaseLookup.uGrid.FieldLayoutResourceString = "BCFLookupGrid";
            //Set the grid main table name from the RObject detail table
            uBaseLookup.uGrid.MainTableName = "bcf_lookup";
            ...
            uBaseLookup.ReturnParmFields.Add("bcf_number");
