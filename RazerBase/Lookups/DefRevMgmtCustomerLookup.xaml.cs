...
{
    /// <summary>
    /// Interaction logic for DefRevMgmtCustomerLookup.xaml
    /// </summary>
    public partial class DefRevMgmtCustomerLookup : DialogBase, IScreen
    {
        ...
        public DefRevMgmtCustomerLookup()
        {
            InitializeComponent();
            //Init();
        }
        ...
        public void Init(cBaseBusObject businessObject)
        {
            ...
            uBaseLookup.AddLookup("txtCustomerNumber", "Customer");
            ...
            uBaseLookup.uGrid.FieldLayoutResourceString = "DefRevMgmtCustomerLookupGrid";
            //Set the grid main table name from the RObject detail table
            uBaseLookup.uGrid.MainTableName = "customer_lookup";
            ...
            uBaseLookup.ReturnParmFields.Add("Customer");
