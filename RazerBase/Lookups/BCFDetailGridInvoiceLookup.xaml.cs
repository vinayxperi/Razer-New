...
namespace RazerBase.Lookups
{
    ...
    #region class BCFDetailGridInvoiceLookup
    /// <summary>
    /// This class represents a 'EntityLookup' object.
    /// </summary>
    public partial class BCFDetailGridInvoiceLookup : DialogBase
    {
        ...
        /// </summary>
        public BCFDetailGridInvoiceLookup() : base()
        {
        ...
        private void DialogBase_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            //{
            //    txtEntityName.Text = cGlobals.ReturnParms[0].ToString();
            ...
            //if (cGlobals.ReturnParms.Count > 0)
            //{
            //    txtContractName.Text = cGlobals.ReturnParms[0].ToString();
            //    FilterKeyPress(txtContractName, null);
            //    //terKeyPress(txt  txtEntityName.Text = cGlobals.ReturnParms[1].ToString();
            //    //  FilEntityName, null);
            //}
        ...
        public void Init()
        {
            ...
            uBaseLookup.AddLookup("txtEntityName", "entity_name");
            uBaseLookup.AddLookup("txtContractName", "contract_name");
            ...
            uBaseLookup.uGrid.FieldLayoutResourceString = "BCFDetailGridInvoiceLookup";
            uBaseLookup.uGrid.MainTableName = "BCFDetailGridInvoiceLookup";
        ...
        private void GetLookupVals()
        {
            ...
            obj.BusObjectName = "BCFDetailGridInvoiceLookup";
            ...
            if (cGlobals.ReturnParms.Count > 0)
            {
                obj.Parms.AddParm("@BCF_number", cGlobals.ReturnParms[0]);
                
            }
            else
            {
                obj.Parms.AddParm("@BCF_number", ' ');
            }
