...
namespace RazerBase.Lookups
{
    ...
    /// </summary>
    public partial class AdjustmentUACashLookup : DialogBase
    {
        ...
        public void Init()
        {
            ...
            uBaseLookup.uGrid.FieldLayoutResourceString = "adjuacash_lookupgrid";
            uBaseLookup.uGrid.MainTableName = "adjuacashlookup";
        ...
        {
            obj = new cBaseBusObject("AdjustmentUACashlookup");
            obj.BusObjectName = "AdjustmentUACashlookup";
