...
{
    /// <summary>
    /// Interaction logic for DefRevMgmtCompanyLookup.xaml
    /// </summary>
    public partial class DefRevMgmtCompanyLookup : DialogBase, IScreen
    {
        ...
        public DefRevMgmtCompanyLookup()
        {
            InitializeComponent();
            //Init();
        }
        ...
        public void Init(cBaseBusObject businessObject)
        {
            ...
            uBaseLookup.uGrid.FieldLayoutResourceString = "DefRevMgmtCompanyLookupGrid";
            //Set the grid main table name from the RObject detail table
            uBaseLookup.uGrid.MainTableName = "company_lookup";
            ...
            uBaseLookup.ReturnParmFields.Add("Company");
