...
{
    /// <summary>
    /// Interaction logic for ContractLookup.xaml
    /// </summary>
    public partial class ContractLookup : DialogBase, IScreen
    {
        ...
        public void Init(cBaseBusObject businessObject)
        {
            ...
            uBaseLookup.AddLookup("txtContractEntity", "mso_name");
            uBaseLookup.AddLookup("txtContractEntityID", "mso_id");
            uBaseLookup.AddLookup("txtContractDescription", "contract_description");
            uBaseLookup.AddLookup("txtPrimaryProduct", "product_code");
            //uBaseLookup.AddLookup("txtLCRNumber", "lcr_Number");
            //RES 4/11/16 change to clm_number
            uBaseLookup.AddLookup("txtLCRNumber", "clm_number");
            ...
            uBaseLookup.uGrid.FieldLayoutResourceString = "ContractLookup";
            //Set the grid main table name from the RObject detail table
            uBaseLookup.uGrid.MainTableName = "contract_lookup";
            ...
            uBaseLookup.ReturnParmFields.Add("contract_id");
            uBaseLookup.ReturnParmFields.Add("contract_description");
            ...
            CurrentBusObj.Parms.AddParm("@show_archived", "0");
        ...
        public void ReturnSelectedData()
        {
            ...
            dataKeys.Add("contract_id");
            dataKeys.Add("contract_description");
