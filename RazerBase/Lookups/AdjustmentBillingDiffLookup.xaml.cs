...
namespace RazerBase.Lookups
{
    ...
    /// </summary>
    public partial class AdjustmentBillingDiffLookup : DialogBase
    {
        ...
        /// </summary>
        public AdjustmentBillingDiffLookup()
            : base()
        {
            InitializeComponent();
            Init();
        ...
        public void Init()
        {
            ...
            uBaseLookup.uGrid.FieldLayoutResourceString = "adjbillingdiff_lookupgrid";
            uBaseLookup.uGrid.MainTableName = "adjbillingdifflookup";
        ...
        {
            obj = new cBaseBusObject("AdjustmentBillingDiffLookup");
            obj.BusObjectName = "AdjustmentBillingDiffLookup";
