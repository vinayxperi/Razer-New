...
namespace RazerBase.Lookups
{
    ...
    /// </summary>
    public partial class UnitTypeLookup : DialogBase
    {
        ...
        public void Init()
        {
            ...
            uBaseLookup.ReturnParmFields.Add("unit_type_id");
            ...
            uBaseLookup.uGrid.FieldLayoutResourceString = "UnitTypeLookupGrid";
            uBaseLookup.uGrid.MainTableName = "unit_type_lookup";
        ...
        {
            obj = new cBaseBusObject("UnitTypeLookup");
            obj.BusObjectName = "UnitTypeLookup";
