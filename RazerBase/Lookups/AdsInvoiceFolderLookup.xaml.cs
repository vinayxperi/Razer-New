...
namespace RazerBase.Lookups
{
    ...
    #region class AdsInvoiceFolderLookup
    /// <summary>
    /// This class represents a 'EntityLookup' object.
    /// </summary>
    public partial class AdsInvoiceFolderLookup : DialogBase
    {
        ...
        public void Init()
        {
            ...
            uBaseLookup.uGrid.FieldLayoutResourceString = "AdsInvoiceFolderLookup";
            uBaseLookup.uGrid.MainTableName = "adsinvoicelookup";
        ...
        private void GetLookupVals()
        {
            ...
            obj.BusObjectName = "AdsInvoiceFolderLookup";
