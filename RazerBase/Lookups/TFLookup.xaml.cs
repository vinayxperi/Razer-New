...
{
    /// <summary>
    /// Interaction logic for TFLookup.xaml
    /// </summary>
    public partial class TFLookup : DialogBase, IScreen
    {
        ...
        public void Init(cBaseBusObject businessObject)
        {
            ...
            uBaseLookup.AddLookup("txtCustomerNumber", "old_customer_number");
            uBaseLookup.AddLookup("txtCustomerName", "old_customer_name");
            ...
            uBaseLookup.uGrid.FieldLayoutResourceString = "TFLookupGrid";
            //Set the grid main table name from the RObject detail table
            uBaseLookup.uGrid.MainTableName = "tf_lookup";
            ...
            uBaseLookup.ReturnParmFields.Add("tf_number");
