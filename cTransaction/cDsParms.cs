...
{
    /// <summary>
    /// The cDsParms is for use on the client side of the web transaction serivce since the cSpParm object
    /// is not serializable.  It is used to create a dataset of parameters.
    /// </summary>
    /// <remarks>
    /// Brian Dyer, Rovi --May 16, 2011
    /// </remarks>
    public class cDsParms
    {
        ...
        /// <remarks>Used to pass parameters as a collection to the Transaction web service</remarks>
